        ...
        @endif
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 mb-4">
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#addWalletModal">Dodaj portfel</button>
                </div>
            </div>
            ...
            <!-- Dropdown Card Example -->
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary"><a href="{{ route('show', $wallet->name) }}">{{ $wallet->name }}, {{ $wallet->user_id }}</a></h6>
